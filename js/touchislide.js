...
this.each(function(){ 
	...
	if(typeof(navimgs)!=='undefined'){
		...
		navimgs.css({"position":"absolute","z-index":"3","overflow":"hidden","display":"block","width":"auto","right":"10px","height":circler,"bottom":navimgsbuttom});
		circlewrapper.css({"position":"relative","overflow":"hidden","width":"auto","height":circler,"margin":"auto"});		
		circles.css({'position':"relative","float":"left","max-width":4,"max-height":4,"margin-left":slideWrapperWidth*0.01});			
	...
	function canvacircle(canvanum){
		...
		for(var i=0;i<circles.length;i++){
			if(canvassuport){
				...
				circles.css("background","rgba(255, 255, 255, 0.5);");				
				circlewrapper.children('canvas:eq('+canvanum+')').css("background","#fff");				
			}
